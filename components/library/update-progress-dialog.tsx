...
/** Inner component re-mounts when entry.id + open changes — resets all state cleanly. */
...
export function UpdateProgressDialog({ entry, open, onOpenChange }: Props) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* key forces remount of inner component when dialog (re)opens, resetting local state */}
